...
public class MoviesLoadStateAdapter extends
    ...
    public static class LoadStateViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(LoadState loadState){
            ...
            mProgressBar.setVisibility(loadState instanceof LoadState.Loading ? View.VISIBLE
                    : View.GONE);

            mRetry.setVisibility(loadState instanceof LoadState.Error ? View.VISIBLE
                    : View.GONE);

            mErrorMsg.setVisibility(loadState instanceof LoadState.Error ? View.VISIBLE
                    : View.GONE);
        }
    }
