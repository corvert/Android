...
public class MyViewModel extends AndroidViewModel {
    ...
    //AndroidViewModel class is a subclass of ViewModel and similar to them, they are designed to
    //store and manage UI-related data are responsible to prepare & provide data for UI and
