...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        //Called by recyclerView when it needs to display or update an item at a specific
    ...
    public void setContacts(ArrayList<Contacts> contacts) {
        ...
        //Inform the associated RecyclerView that the underlying dataset has changed, and the
        // RecyclerView should refresh its views to reflect these changes.
