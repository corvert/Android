...
public class DemoWorker extends Worker {
    ...
    public Result doWork() {
        ...
        /**
         * The Result returned from doWork() informs the WorkManager service whether the work
         * succeeded and, in the case of failure, whether or not the work should be retried.
         * - Result.success(): The work finished successfully
         * - Result.failure(): The work failed.
         * - Result.retry(): The work failed and should be tried at another time according to it's
         *                      retry policy
         */
