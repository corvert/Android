...
import com.example.moviepro.serviceApi.MovieApiService;
import com.example.moviepro.serviceApi.RetrofitInstance;
...
public class MovieRepository {
    ...
    public MutableLiveData<List<Movie>> getMutableLiveData() {
        ...
        //perform network request in the background thread and handle the response on the
        //main(UI) thread
